...
![Nuage de points représentant les pays en fonction de leur différence de REE entre garçons-filles avec la différence de bien-être entre catégories socio-économiques](images_rapports/figure20_barplot_REE_escs.pdf){fig-cap="Nuage de points représentant les pays en fonction de leur différence de REE entre garçons-filles avec la différence de bien-être entre catégories socio-économiques"}

A MODIFIER (titre, note de lecture...)
