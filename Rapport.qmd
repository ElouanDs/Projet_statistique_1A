...
Note de lecture 1: RELATST = REE globale, TEACHSUP = REE maths, EXPWB = indice de bien-être récent, ANXMAT = anxiété en mathématiques, BELONG = sentiment d'appartenance, BULLIED = indice de harcèlement

Note de lecture 2: La corrélation entre l'indice d'appartenance et de harcèlement est de -0.26
