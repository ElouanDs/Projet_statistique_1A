...
On peut donc observer sur le nuage de points ci-dessus, que sur la base d'un nouveau critère de classification des pays les résultats obtenus diffèrent del'analyse précédente. En effet, la REE dans les pays à niveaux de développement qualifiés de “Intermédiaire” et “Faible” semble n'avoir pratiquement aucun effet sur le bien-être des élèves de ces pays. Ainsi, contrairement à ce que l'on pouvait observer dans la partie précédente, il n'y a ici pas de lien négatif entre ces deux indices moyens pour les pays à IDH moins importants. On s'apperçoit en calculant les nouveau coefficients de corrélation que ces derniers sont pratiquement nuls (respectivement -0.050 et -0.002). Ceci s'explique en partie par le fait, que certains pays de l'OCDE à IDH plus faibles, se retrouvent "déclassés" au sein de la nouvelle classification. En revanche, pour les pays à niveau de développement "Élevé" le lien de corrélation reste similaire (0.30). Ce qui signifie que plus la REE au sein de ces pays est positive pour les élèves, plus leur bien-être sera affecté positiviement par ces intéractions. Ce lien ce fait également souligner dans le nuage de point ci-dessus. On peut donc affirmer que plus le niveau de développement d'un pays est important plus la REE a un impact important sur le bien-être des élèves.
