...
![Figure 1: Comparaison des moyennes générale des élèves en fonction de leur statut de réponse sur le REE global](images_rapports/figure2_comparaison_NA_notes_relatst.png){fig-cap="Comparaison des moyennes générale des élèves en fonction de leur statut de réponse sur le REE global"}
...
![Graphique en barre indiquant le taux de réponse positives selon les questions](images_rapports/figure5_Reponses_indiquant_une _relation_positive.png){fig-cap="Graphique en barre indiquant le taux de réponse positives selon les questions"}
...
![Matrice de corrélation entre les variables](images_rapports/figure7_matrice_correlation_variables.png){fig-cap="Matrice de corrélation entre les variables"}
...
![Figure 8: Boxplots de la valeurs de l'indice de REE global selon l'indice socio_économique](images_rapports/figure9_La_relation_élève-enseignant_selon_le_statut_socio-économique_des_parents.png){fig-cap="Boxplots de la valeurs de l'indice de REE global selon l'indice socio_économique"}
...
![Figure 9 : Boxplots représentant la valeur de la REE ciblée sur l'enseignant de mathématique en fonction de la valeur de l'indice socio-économique ](images_rapports/figure10_La_relation_avec_lenseignant_de_mathématique_selon_le_statut_socio-économique_des_parents.png){fig-cap="Boxplots représentant la valeur de la REE ciblée sur l'enseignant de mathématique en fonction de la valeur de l'indice socio-économique"}
...
"Le statut socio-économique peut avoir une influence considérable sur les résultats de l'apprentissage. Si les mauvais résultats ne découlent pas automatiquement d'un désavantage socio-économique, les écoles reproduisent parfois les schémas existants d'avantages et de désavantages, au lieu de créer une distribution plus équitable des opportunités d'apprentissage et des résultats pour les élèves." [Causalité entre statut socio-économique et résultats scolaire, OCDE](https://www.oecd.org/fr/topics/sub-issues/student-socio-economic-status.html)

Cette relation se confirme avec une Analyse en composantes principales (ACP).

![Figure annexe: Cercle de corrélation](images_rapports/figure_annexe_ACP.png){fig-cap="Cercle de corrélation"}
...
![Figure 11: Nuage de points représentant les pays en fonction de leur REE ciblée en mathématiques et la qualité des cours de mathématiques ](images_rapports/figure12_Corrélation_entre_qualité_cours_maths_et_la_REE_moyenne_des_pays.png){fig-cap="Nuage de points représentant les pays en fonction de leur REE ciblée en mathématiques et la qualité des cours de mathématiques"}
Note de lecture : ...
...
![Figure 12 : Nuage de points représentant des groupes de pays selon la qualité de la REE ciblée en mathématiques et les notes de mathématiques ](images_rapports/figure13_Typologie_des_pays_selon_la_qualité_des_REE_des_enseignements_en_mathématiques_et_les_notes.png){fig-cap="Nuage de points représentant des groupes de pays selon la qualité de la REE ciblée en mathématiques et les notes de mathématiques"}
...
![Figure 13 : Carte du regroupement des pays suite au k-means ](images_rapports/figure14_Répartition_mondiale_des_modèles_de_relation_élève-enseignant.png){fig-cap="Carte du regroupement des pays suite au k-means"}
