...
```{r, echo=FALSE}
cor_matrix <- cor(vars)
pdf("images_rapports/figure15_Matrice_de_correlation_bien_etre_REE.pdf", width = 6, height = 4)
...
pdf("images_rapports/figure18_graph_barre_sexe.pdf", width = 6, height = 4)
