...
Il serait donc non approprié d'amputer seulement toutes les non-réponses par la moyenne totale pour les pays n'ayant pas distribués cette partie du questionnaire correspondant à la construction de l'indice. Nous allons donc supprimés ces pays de notre jeu de données. Pour les autres pays, on amputera les non-réponses par la moyenne.
...
Maintenant que nos données sont nettoyés, nous 
```{r, echo = FALSE}
