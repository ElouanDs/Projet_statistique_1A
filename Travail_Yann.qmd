...
## Relation entre REE et le niveau académique individuel 
...
## Relation entre REE et le niveau académique national
...
## REE et le rapport aux apprentissages
...
Enfin, on élabore alors une analyse en composantes principales sur nos variables de bien-être, puis on trace le cercle des corrélations et contributions des variables pour avoir une vue globale du problème, c'est à dire pré-déterminer quels seront les différents liens, et ce sur les 2 premiers axes de cette analyse en composante factorielle :
...
On note ici que les indices sont centrés autour de 0, ils ont été normalisés, ce qui facilite l'étude. De plus, on note que les dispersions sont plutôt symétriques à l'exception du harcèlement.
...
```
Par souci de complexité, on décide de scinder l'indice de catégorie socio-professionnelle en variable qualitative. 
En utilisant 2 tertiles, on obtient directement tous les individus avec un indice de CSP faisant partis des 33% les plus faibles, ceux faisant partis des 66% les plus faibles ET des 66% les plus élevés, et faisant partis des 33% les plus élevés.
...
La CSP semble peu agir sur cela. Toutefois, on remarque que les élèves ayant des parents se situant dans des catégories socio-professionnelles dites “plus élevées”, sont sujets à une moins bonne relation entre l'élève et l'enseignant. 
...
Même si la différence est faible, les élèves de haute CSP sont plus touchés par les REE, c'est-à -dire que leur bien-être en dépend plus. Cela va dans le sens de notre analyse précédente ; si les élèves montrent être plus affectés par la REE, il fait sens que la REE ne soit pas indifférente ou inexistante du point de vue de l’élève, mais bien forte ou faible (faible dans ce cas-ci).

Construisons maintenant un modèle comportant les CSP pour voir si celles-ci se montrent réellement impactantes dans nos analyses ;
...
Ce dernier comporte 51% de femmes pour 49% d'hommes. Ce qui nous conviendra amplement pour notre étude.
...
On remarque par l’utilisation de statistiques descriptives et des représentations visuelles que les hommes éprouvent un bien-être plus élevé que les femmes dans le milieu scolaire. En revanche, la relation entre élèves et enseignants semble être en moyenne de meilleure qualité chez les femmes que chez les hommes.
...
Nous pouvons alors remarquer que les coefficients directeurs concernant les modalités de sexe sont les plus élevées du modèle. 
De plus, le R² de ce modèle est légèrement supérieur aux deux précédents.
(0.1116 > 0.103 > 0.098)


Dans notre étude, nous affirmons donc que le sexe doit être davantage pris en compte que la catégorie socio-professionnelle dans l'analyse du bien-être selon la REE par exemple.
